...
REM
REM Generated by Vivado on Wed May 20 10:21:05 +0530 2026
...
echo "xvlog --incr --relax -prj aes_top_vlog.prj"
call xvlog  --incr --relax -prj aes_top_vlog.prj -log xvlog.log
