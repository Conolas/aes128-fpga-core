...
HD_PWD='C:/Users/jatin/aes_decryption/aes_decryption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_decrypt_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_decrypt_top.tcl -notrace
