...
HD_PWD='C:/Users/jatin/aes_decryption/aes_decryption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_decrypt_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_decrypt_top.tcl
