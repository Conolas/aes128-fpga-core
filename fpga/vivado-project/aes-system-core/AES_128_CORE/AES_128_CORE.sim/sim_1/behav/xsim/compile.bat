...
REM
REM Generated by Vivado on Wed May 20 21:15:44 +0530 2026
...
echo "xvlog --incr --relax -prj aes_system_top_tb_vlog.prj"
call xvlog  --incr --relax -prj aes_system_top_tb_vlog.prj -log xvlog.log
