...
HD_PWD='C:/Users/jatin/AES_128_CORE/AES_128_CORE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_system_top.tcl
