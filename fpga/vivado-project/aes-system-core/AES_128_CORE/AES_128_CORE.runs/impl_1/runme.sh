...
HD_PWD='C:/Users/jatin/AES_128_CORE/AES_128_CORE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_system_top.tcl -notrace
